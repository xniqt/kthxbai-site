...
export default function App() {
  ...
  const factionsData = [
    { 
      ...
      completedVol2: ["terracotta", "pink_armor", "hive_flowers", "emerald_pyramid", "end_heads", "zoo"] 
    },
    { 
      name: "boo", 
    ...
    { 
      ...
      completedVol2: ["mooshroom", "terracotta", "smelter", "hive_flowers", "egg_cake", "zoo", "emerald_pyramid", "end_heads"]
    },
    { 
      name: "Transgender", 
      members: ["WuvX"], 
