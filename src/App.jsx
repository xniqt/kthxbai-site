...
export default function App() {
  ...
  const factionsData = [
    { 
      ...
      completed: ["hq", "horse", "farm", "ender", "heart", "breath", "rod", "redstone", "tame", "banner", "pumpkin", "egg", "apple", "map"]
    },
    { 
      name: "boo", 
      members: "xniqt", 
    ...
    { 
      ...
      completed: ["hq", "bee", "pumpkin", "horse", "farm", "banner", "redstone", "ender", "heart", "map"] 
    },
    { 
      name: "Transgender", 
      members: "WuvX", 
