...
export const factionsData = [
  ...
  { 
    ...
    completedVol3: ["gamba", "shopping", "charged_creeper", "ocean_dome", "shulker_chest", "all_signs", "sorting_system", "raw_ore_blocks", "all_banners", "scutes_stack", "all_trims", "nether_highway", "auto_tree_farm", "tame_trio", "diamond_horses", "clear_ancient_city", "jungle_treehouse"]
  },
];