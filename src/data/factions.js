...
export const factionsData = [
  { 
    ...
    completedVol3: ["sorting_system", "tame_trio", "diamond_horses", "all_signs", "raw_ore_blocks", "nether_highway", "scutes_stack", "shopping", "shulker_chest", "all_trims", "all_banners", "charged_creeper", "auto_tree_farm", "gamba", "ocean_dome", "jungle_treehouse", "clear_ancient_city", "netherite_pyramid"] 
  },
  { 
    name: "boo", 
  ...
  { 
    ...
    completedVol3: ["gamba", "shopping", "charged_creeper", "ocean_dome", "shulker_chest", "all_signs", "sorting_system", "raw_ore_blocks", "all_banners", "scutes_stack", "all_trims", "nether_highway", "auto_tree_farm", "tame_trio", "diamond_horses", "clear_ancient_city", "jungle_treehouse", "netherite_pyramid"]
  },
];