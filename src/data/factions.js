...
export const factionsData = [
  { 
    ...
    completedVol3: ["sorting_system", "tame_trio", "diamond_horses", "all_signs", "raw_ore_blocks", "nether_highway", "scutes_stack", "shopping", "shulker_chest", "all_trims", "all_banners", "charged_creeper", "auto_tree_farm", "gamba", "ocean_dome", "jungle_treehouse", "clear_ancient_city"] 
  },
  { 
    name: "boo", 
