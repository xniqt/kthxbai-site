...
export const factionsData = [
  { 
    ...
    completedVol3: ["sorting_system", "tame_trio", "sorting_system", "diamond_horses", "all_signs", "raw_ore_blocks", "nether_highway", "scutes_stack", "shopping", "shulker_chest", "all_trims", "all_banners"] 
  },
  { 
    name: "boo", 
